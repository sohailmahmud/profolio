                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            @if(!is_null($userDefaultLang))
                                <a href="#" class="btn btn-primary float-right btn-sm" data-toggle="modal"
                                   data-target="#createModal"><i class="fas fa-plus"></i> Add Portfolio Category</a>
                ...
                <div class="modal-body">
                    <form id="ajaxForm" class="modal-form create" action="{{route('user.portfolio.category.store')}}"
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-warning"><small>The higher the serial number is, the later the portfolio
                ...
                <div class="modal-body">
                    <form id="ajaxEditForm" class="" action="{{route('user.portfolio.category.update')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-warning"><small>The higher the serial number is, the later the blog category
